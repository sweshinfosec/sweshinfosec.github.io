...
.stat-item{background:#111;border:1px solid #1e1e1e;border-radius:6px;padding:10px 18px;text-align:center;min-width:90px;}
...
<div class="hero-wrap">
  ...
  <div class="hero-top">
    ...
    <div class="hero-ident">
      <div class="hero-name">SweshInfoSec</div>
      <div class="hero-tagline">Security Researcher · VAPT · Bug Bounty · Penetration Testing</div>
      <div class="hero-social">
        <a href="mailto:sweshinfosec@gmail.com">✉ Email</a>
        <a href="https://twitter.com/SweshInfoSec">𝕏 Twitter</a>
        <a href="https://github.com/sweshinfosec">⌥ GitHub</a>
